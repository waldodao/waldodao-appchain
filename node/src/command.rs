...
use waldodao_appchain_runtime::Block;

impl SubstrateCli for Cli {
	fn impl_name() -> String {
		"Waldo Dao Appchain".into()
	}
	...
	fn support_url() -> String {
		"https://github.com/waldodao/waldodao-appchain/issues/new".into()
	}
	...
	fn native_runtime_version(_: &Box<dyn ChainSpec>) -> &'static RuntimeVersion {
		&waldodao_appchain_runtime::VERSION
	}
}
